...
<p align="center">
  ...
  <a href="https://github.com/xuhuanstudio/codex-styler/releases/tag/v0.2.0-beta.4">Download Beta</a> ·
...
<p align="center">
  ...
  <a href="https://github.com/xuhuanstudio/codex-styler/releases/tag/v0.2.0-beta.4"><img alt="Preview version" src="https://img.shields.io/badge/preview-v0.2.0--beta.4-2563EB?style=flat-square"></a>
...
> [!IMPORTANT]
> Codex Styler 0.2 is a Creator Beta. The macOS DMG is ad-hoc signed but not notarized, and the Windows EXE is not Authenticode-signed. Windows Beta 4 includes a rebuilt Store launch and bounded restart lifecycle but still awaits community real-device verification; v1 Stable remains gated on complete evidence and platform code signing.
...
- **[Windows 11 / x64 — installer EXE](https://github.com/xuhuanstudio/codex-styler/releases/download/v0.2.0-beta.4/Codex-Styler_0.2.0-beta.4_x64-unsigned-setup.exe)**
...
The [pre-release page](https://github.com/xuhuanstudio/codex-styler/releases/tag/v0.2.0-beta.4) includes SHA-256 checksums, an SPDX SBOM, build attestations, updater artifacts, tested scope, and known limitations. Intel macOS is not included. Windows Beta 4 is CI-built and structurally verified but remains marked as awaiting community real-device validation.
