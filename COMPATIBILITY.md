...
| --- | --- | --- | --- |
| macOS | Apple Silicon | Development and prototype target | Alpha |
...
Unknown Codex Desktop versions default to safe mode. A version is added to the tested matrix only after detection, launch, injection, route changes, pause, restore, and normal restart are verified.
