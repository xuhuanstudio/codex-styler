...
![Codex Styler 交互玩法资源库，当前选择三段落珠](docs/media/composer-interactions-manager.webp)

目前可选择**三段落珠**、**配置胶囊机**、**三环锻造**、**三轴控制台**和**任务航图**。操作过程本身决定三项真实设置，不存在与结果脱节的装饰分数或奖励。

<table>
  <tr>
    <td align="center" width="50%"><a href="docs/media/composer-interactions-capsule-crane.webp"><img src="docs/media/composer-interactions-capsule-crane.webp" alt="配置胶囊机展示五套完整 Codex 配置"></a><br><sub>抓取前即可看到每枚胶囊对应的模型、推理强度和速度。</sub></td>
    <td align="center" width="50%"><a href="docs/media/composer-interactions-result.webp"><img src="docs/media/composer-interactions-result.webp" alt="配置结果逐项显示模型、推理强度和速度"></a><br><sub>修改 Codex 前会逐项展示配置差异。</sub></td>
  </tr>
</table>
