        ...
        <main className="creator-stage">
          {project.step === "import" && (
            <section className="creator-panel creator-import">
              ...
              <div className="creator-dropzone-shell">
                ...
                >
                  {project.source?.files.length ? (
                    ...
                    <>
                      <Upload size={22} />
                      <strong>
                        {dragActive ? c.releaseFiles : c.chooseFiles}
                      </strong>
                ...
                {project.source?.files.length ? (
                  <button
                    ...
                    onClick={() => setConfirmAction({ kind: "remove-source" })}
              ...
              />
              <section
                className="creator-import-guide"
                aria-label={c.importGuideTitle}
              >
                <div>
                  <Sparkles size={16} />
...
function InteractiveAlignmentStage({
  frame,
  logicalFrame,
  comparisonFrames,
  canvas,
...
function SourceMediaPreview({
  ...
  useEffect(() => {
    ...
    if (kind === "video") onVideoStatus("loading");
