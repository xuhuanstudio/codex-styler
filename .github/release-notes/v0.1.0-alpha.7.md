...
Release tag: `v0.1.0-alpha.7`

## Download and install

### macOS 13+ on Apple Silicon

1. Download `Codex-Styler_0.1.0-alpha.7_aarch64-unsigned.dmg`.
...
1. Download `Codex-Styler_0.1.0-alpha.7_x64-unsigned-setup.exe`.
2. Compare its SHA-256 digest with `SHA256SUMS.txt`.
...
- `Codex-Styler_0.1.0-alpha.7.spdx.json` exports the repository dependency graph as SPDX 2.3.
...
```bash
gh attestation verify Codex-Styler_0.1.0-alpha.7_aarch64-unsigned.dmg \
  --repo xuhuanstudio/codex-styler

gh attestation verify Codex-Styler_0.1.0-alpha.7_x64-unsigned-setup.exe \
  --repo xuhuanstudio/codex-styler
```
